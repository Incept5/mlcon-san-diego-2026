...
Usage:
    python gdpr_viewer.py           # serves on port 7002
...
<div class="header">
  <div class="header-inner">
    ...
    <p>Browse, search, and read all articles of the General Data Protection Regulation</p>
...
function selectArticle(artNum) {
  ...
  panel.innerHTML = `
    <div class="detail-header">
      ...
      <h2>${escHtml(art.title || art.article)}</h2>
    </div>
